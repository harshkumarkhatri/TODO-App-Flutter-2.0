...
import 'package:flutter_application_3/completedItems.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              ? Padding(
                  ...
                  child: TextField(
                    decoration: InputDecoration(
                        hintText: "Enter text to be replaced/updated"),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        tooltip: "Show me the data after adding",
